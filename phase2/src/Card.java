  ...
  private void deductFare(String vehicle) {
    ...
    if (vehicle.equals("bus")) {
      if (currentTrip.getCurrentFare() + 2 <= 6 & currentTrip.getIsContinuous()) {
        ...
        if (balance >= 0) {
          ...
          this.user.updateAverageMonthlyFare(
              currentTrip.getEnterTime().toString().split(" ")[1], 2);
        ...
        if (balance >= 0) {
          ...
          this.user.updateAverageMonthlyFare(
              currentTrip.getEnterTime().toString().split(" ")[1], diff);
    ...
    // For the subway case.
      ...
      if (currentTrip.getCurrentFare() + fare <= 6 & currentTrip.getIsContinuous()) {
        ...
        this.user.updateAverageMonthlyFare(
            currentTrip.getEnterTime().toString().split(" ")[1], fare);
