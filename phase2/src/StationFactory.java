...
public class StationFactory {
    private HashMap<String, SubwayStation> subwayStationHashMap = new HashMap<>();
    private HashMap<String, BusStation> busStationHashMap = new HashMap<>();
    ...
    HashMap getSubwayStationHashMap(){
        return this.subwayStationHashMap;
    }

    HashMap getBusStationHashMap(){
        return this.busStationHashMap;
    }
}
