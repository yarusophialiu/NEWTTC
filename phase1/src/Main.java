...
public class Main {
  /** main method for our program, read stations.txt and record information from them, and read events.txt and pass the
   * information in it one line after one line to PrestoCardSystem to execute those events.*/
